...
Notation "u /ₛ v" := (c_subst1 u v) (at level 50, left associativity).
...
Lemma sub_proper_prf : ind_args t_sub_proper_P c_sub_proper_P.
  ...
  all: intros ? ?; unfold t_shift; try rewrite H0; try rewrite H1; reflexivity.
Qed.
...
Lemma ren_sub_prf : ind_args t_ren_sub_P c_ren_sub_P.
  ...
  all: try apply c_sub_eq; try apply t_sub_eq; auto.
  all: intros ? i; dependent elimination i; cbn; auto.
  all: unfold t_shift; repeat rewrite t_ren_ren.
  all: apply t_ren_eq; auto.
Qed.
...
Lemma sub_ren_prf : ind_args t_sub_ren_P c_sub_ren_P.
  ...
  apply t_sub_eq; auto; rewrite a_shift_ren; auto.
Qed.
...
Lemma sub_id_l_prf : ind_args t_sub_id_l_P c_sub_id_l_P.
  ...
  rewrite (t_sub_eq _ _ a_shift_id _ _ _ eq_refl); auto.
Qed.
