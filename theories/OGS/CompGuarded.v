...
|*)
  ...
  Proof.
    (* setup wf induction on no-infinite-redex *)
    revert Φ u v γ j.
    ...
    (* setup wf induction on no-infinite var lookup *)
    ...
    (* lookup is not a var: step on no-infinite-redex *)
    - unfold ev_guarded; cbn.
